...
class DistanceMapsFromAnchorModel(nn.Module):
    ...
    def forward(self, x):
        ...
        return roc_curves, median_dist, wasser_dist, mean_dist
...
class WellAggFeatureDistanceMetrics:
    ...
    distance_keys = distrib_metric_keys + roc_auc_keys
    ...
    def load_and_preprocess_features(self, ):
        ...
        features = features.loc[np.isin(features["well-id"], enough_cell_count_well_ids)]
        ############################################################################################################
